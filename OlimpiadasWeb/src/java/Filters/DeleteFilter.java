...
public class DeleteFilter implements Filter {
    ...
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
        ...
        if (debug) {
            log("DeleteFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("DeleteFilter:DoAfterProcessing");
        }
...
//        doBeforeProcessing(req, res);
        ...
        try {  
            ...
            if(email==null|| email.equals("")) throw new BaseException("Acceso denegado", "El usuario no est&aacute; habilitado para eliminar registros");
             
            if(req.getMethod().equalsIgnoreCase("POST")){
                 if(id_tipo_usuario ==null) throw new BaseException("ERROR", "El usuario no est&aacute; habilitado para eliminar registros");
//                     res.sendRedirect(PathCfg.FORBIDDEN);
                
                String back = req.getRequestURI();
                if (req.getQueryString()!=null)
                    back += "?" + req.getQueryString();
                
                if(id_tipo_usuario>2){
                    throw new BaseException("ERROR", "<center><h5><b>Acceso denegado</b><h5></center> <br> El usuario no est&aacute; habilitado para eliminar registros");
...
//        doAfterProcessing(req, res);
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("DeleteFilter: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("DeleteFilter(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("DeleteFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("DeleteFilter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("DeleteFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("DeleteFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("DeleteFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
