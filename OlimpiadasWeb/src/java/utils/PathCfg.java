...
public class PathCfg {
    ...
    public static final String PAGE_TITLE = "ActiSoft";
    ...
    public static final String MEDALLERO = "Medallero";
    ...
    public static final String DELEGACION_MASIVA = "Delegacion_masiva";
    ...
    public static final String JUGADOR_CATEGORIA = JUGADOR + "Categoria";
